...
特に日本語ユーザーの方には、koedeskのデフォルトモデルであるElevenLabs Scribe V2の日本語品質をぜひ体感していただきたいです。koedeskは**1日5分まで、期限なし・クレジットカード不要**でずっと無料で使えます。気に入っていただけたら、月10ドルのProプランで文字起こしが無制限になります。
